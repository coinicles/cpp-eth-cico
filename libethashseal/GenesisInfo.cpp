...
#include "genesis/cicoMainNetwork.cpp"
...
#include "genesis/test/cicoTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::cicoMainNetwork: return c_genesisInfoCicoMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::cicoTestNetwork: return c_genesisInfoCicoTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::cicoMainNetwork: return c_genesisStateRootCicoMainNetwork;
    case Network::cicoTestNetwork: return c_genesisStateRootCicoTestNetwork;
